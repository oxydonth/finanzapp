...
async function main() {
  ...
  const txData = [
    // ── February 2026 ────────────────────────────────────────────────────
    tx(user.id, giro.id, 'income-salary', d(2026,2,1), 320000, 'CREDIT', { externalId: 'demo-feb-salary', creditorName: 'Delivery Hero SE', purpose: 'Gehalt Februar 2026', isRecurring: true }),
    ...
    tx(user.id, giro.id, 'transport-public', d(2026,2,2), 5800, 'DEBIT', { externalId: 'demo-feb-bvg', creditorName: 'BVG Berlin', purpose: 'Deutschlandticket Februar 2026', isRecurring: true }),
    tx(user.id, giro.id, 'health-insurance', d(2026,2,5), 3490, 'DEBIT', { externalId: 'demo-feb-tk', creditorName: 'DKV Deutsche Krankenversicherung AG', purpose: 'Zahnzusatzversicherung Beitrag Feb', isRecurring: true }),
    tx(user.id, giro.id, 'health-sports', d(2026,2,5), 5490, 'DEBIT', { externalId: 'demo-feb-gym', creditorName: 'FitnesFirst Berlin', purpose: 'Monatsbeitrag Februar', isRecurring: true }),
    ...
    tx(user.id, giro.id, 'taxes-fees', d(2026,2,28), 5508, 'DEBIT', { externalId: 'demo-feb-gez', creditorName: 'Rundfunk ARD ZDF', purpose: 'Rundfunkbeitrag 01/2026-03/2026', isRecurring: true }),
    tx(user.id, savings.id, 'savings-savings', d(2026,2,1), 2604, 'CREDIT', { externalId: 'demo-feb-savings-in', creditorName: 'Sparkasse Berlin', purpose: 'Zinsgutschrift Januar 2026' }),
    ...
    // ── March 2026 ──────────────────────────────────────────────────────
    tx(user.id, giro.id, 'income-salary', d(2026,3,2), 320000, 'CREDIT', { externalId: 'demo-mar-salary', creditorName: 'Delivery Hero SE', purpose: 'Gehalt März 2026', isRecurring: true }),
    ...
    tx(user.id, giro.id, 'transport-public', d(2026,3,3), 5800, 'DEBIT', { externalId: 'demo-mar-bvg', creditorName: 'BVG Berlin', purpose: 'Deutschlandticket März 2026', isRecurring: true }),
    tx(user.id, giro.id, 'health-insurance', d(2026,3,5), 3490, 'DEBIT', { externalId: 'demo-mar-tk', creditorName: 'DKV Deutsche Krankenversicherung AG', purpose: 'Zahnzusatzversicherung Beitrag Mrz', isRecurring: true }),
    tx(user.id, giro.id, 'health-sports', d(2026,3,5), 5490, 'DEBIT', { externalId: 'demo-mar-gym', creditorName: 'FitnesFirst Berlin', purpose: 'Monatsbeitrag März', isRecurring: true }),
    ...
    tx(user.id, giro.id, 'food-restaurant', d(2026,3,11), 14500, 'DEBIT', { externalId: 'demo-mar-resto1', merchantName: 'Nobelhart & Schmutzig', purpose: 'NOBELHART SCHMUTZIG' }),
    ...
    tx(user.id, giro.id, 'income-other', d(2026,3,15), 120000, 'CREDIT', { externalId: 'demo-mar-freelance', creditorName: 'Pixelpiloten GmbH', purpose: 'Honorar Webentwicklung Rechnung 2026-003' }),

    // ── April 2026 ──────────────────────────────────────────────────────
    tx(user.id, giro.id, 'income-salary', d(2026,4,1), 320000, 'CREDIT', { externalId: 'demo-apr-salary', creditorName: 'Delivery Hero SE', purpose: 'Gehalt April 2026', isRecurring: true }),
    ...
    tx(user.id, giro.id, 'transport-public', d(2026,4,2), 5800, 'DEBIT', { externalId: 'demo-apr-bvg', creditorName: 'BVG Berlin', purpose: 'Deutschlandticket April 2026', isRecurring: true }),
    tx(user.id, giro.id, 'health-insurance', d(2026,4,5), 3490, 'DEBIT', { externalId: 'demo-apr-tk', creditorName: 'DKV Deutsche Krankenversicherung AG', purpose: 'Zahnzusatzversicherung Beitrag Apr', isRecurring: true }),
    tx(user.id, giro.id, 'health-sports', d(2026,4,5), 5490, 'DEBIT', { externalId: 'demo-apr-gym', creditorName: 'FitnesFirst Berlin', purpose: 'Monatsbeitrag April', isRecurring: true }),
    ...
    tx(user.id, giro.id, 'taxes-fees', d(2026,4,28), 5508, 'DEBIT', { externalId: 'demo-apr-gez', creditorName: 'Rundfunk ARD ZDF', purpose: 'Rundfunkbeitrag 04/2026-06/2026', isRecurring: true }),
    ...
    tx(user.id, giro.id, 'income-salary', d(2026,5,2), 320000, 'CREDIT', { externalId: 'demo-may-salary', creditorName: 'Delivery Hero SE', purpose: 'Gehalt Mai 2026', isRecurring: true }),
    ...
    tx(user.id, giro.id, 'transport-public', d(2026,5,2), 5800, 'DEBIT', { externalId: 'demo-may-bvg', creditorName: 'BVG Berlin', purpose: 'Deutschlandticket Mai 2026', isRecurring: true }),
    ...
    tx(user.id, giro.id, 'health-insurance', d(2026,5,5), 3490, 'DEBIT', { externalId: 'demo-may-tk', creditorName: 'DKV Deutsche Krankenversicherung AG', purpose: 'Zahnzusatzversicherung Beitrag Mai', isRecurring: true }),
    tx(user.id, giro.id, 'health-sports', d(2026,5,5), 5490, 'DEBIT', { externalId: 'demo-may-gym', creditorName: 'FitnesFirst Berlin', purpose: 'Monatsbeitrag Mai', isRecurring: true }),
