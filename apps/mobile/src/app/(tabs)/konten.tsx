...
import { Platform, ScrollView, View, Text, StyleSheet, RefreshControl, StatusBar } from 'react-native';
...
export default function KontenScreen() {
  ...
  const total = accounts.reduce((sum, a) => sum + Number(a.balanceCents), 0);
  ...
  return (
    ...
    >
      ...
      <View style={s.list}>
        {accounts.map((a) => {
          const accentColor = typeColors[a.accountType as keyof typeof typeColors] ?? C.brand;
          return (
